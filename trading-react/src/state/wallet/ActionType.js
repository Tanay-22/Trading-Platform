...
export const WITHDRAWAL_MONEY_REQUEST = "TRANSFER_MONEY_REQUEST";
export const WITHDRAWAL_MONEY_SUCCESS = "TRANSFER_MONEY_SUCCESS";
export const WITHDRAWAL_MONEY_FAILURE = "TRANSFER_MONEY_FAILURE";